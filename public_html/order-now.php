...
if(isset($_POST['submit'])) 
{
	...
	$notes_arr = array('Quantity' => $quantity, 'Address' => $addr);
  ...
  <?php include_once("include/analyticstracking.php"); ?>
     ...
     <div class="row" style="margin:0px;" >
          <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 inr-pg-cont-blk" >
			  ...
			  <p><strong>Pricing:</strong> &pound;19.95 for the book + postage and packaging charges ( UK &pound;4.99, International &pound;7.99)</p>
...
<?php if(isset($err_msg) && $err_msg!='') { echo '<p style="color:#FF0000;margin-left:15px;">'.$err_msg.'</p>'; } ?>  
  ...
  <div class="form-group col-lg-5 col-sm-5 col-md-5" style="position:static!important;" >
  ...
  <div class="form-group  col-lg-5 col-sm-5 col-md-5 col-lg-offset-1 col-md-offset-1">
  ...
  <div class="form-group col-lg-5 col-sm-5 col-md-5" style="float:none;">
  ...
  <div class="form-group col-lg-10">
    <div>
	 ...
	 <?php } ?>
			   ...
			   <div class="col-lg-12" >
			  <div class="socials"> 
			 <p class="buynowpg" style="text-align:center; float:none; padding:0px; margin:0px;">Beyond Brilliant will be available from<br/> <span style="color:#ed8000;">28th April</span> <br/>to purchase from The Brilliant Restaurant in Southall or <br/> alternatively you will be able to purchase your copy of the book online</p>
<p class="note" style="font-size:12px; text-align:center; float:none;"><strong>Please note:</strong> Every person that buys a copy of the book from the Brilliant Restaurant, will receive a copy of Brilliant&rsquo;s secret Garam Masala spice blend!</p>
</div>
</div>
</div>
      </div>
